    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                ...
                {/* paragraph 1 */}
                <p className="fs-5">The novel's action takes place in a fishing village near the sea named Thul, located in a
                ...
                {/* paragraph 2 */}
                <p className="fs-5">The family ended up in this situation after Lila, Hari, Kamal, and Belu's father were
                ...
                {/* paragraph 3 */}
                <p className="fs-5">Hari begins to think about better ways in which he could help his family and believes their
                ...
                {/* paragraph 4 */}
                <p className="fs-5">Their situation changes a bit when the de Silva family comes into the village. They are a
                ...
                {/* paragraph 5 */}
                <p className="fs-5">The factory man begins to cause a stir when he tells Hari and other villagers about the
                ...
                {/* paragraph 6 */}
                <p className="fs-5">Hari is roused by the words of Adarkar and decides to go to Bombay to stand up for his
                ...
                {/* paragraph 7 */}
                <p className="fs-5">Jagu agrees to let Hari work in his restaurant, so Hari sends home a postcard letting his
                ...
                {/* paragraph 8 */}
                <p className="fs-5">During the time Hari is in Bombay, Lila finds succor from the de Silva family. When they
                ...
                {/* paragraph 9 */}
                <p className="fs-5">Monsoon season is hard for both Hari in Bombay and the villagers by the sea. When Hari hears
                ...
                paragraph 10
                <p className="fs-5">Hari returns and has an emotional reunion with his sisters. He is stunned to hear of his
                ...
                {/* paragraph 11 */}
                <p className="fs-5">The celebrations are delightful and heartwarming for the family. Hari slips away for a
                ...
                {/* paragraph 12 */}
                <p className="fs-5">The story ends with the family contentedly celebrating, grateful for the positive changes in
                    their lives.</p>
