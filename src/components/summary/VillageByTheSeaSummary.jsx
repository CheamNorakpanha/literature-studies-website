    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                <h1 className="mb-4 fw-bolder">The Village by the Sea</h1>
                <h2 className="mb-4 fw-bold">By Anita Desai</h2>
                <h3 className="mb-4 fw-semibold text-center">Summary</h3>

                {/* paragraph 1 */}
                <p className="fs-5 pb-2">The novel's action takes place in a fishing village near the sea named Thul, located in a
                    ...
                    to financially sustain his family.</p>

                {/* paragraph 2 */}
                <p className="fs-5 pb-2">The family ended up in this situation after Lila, Hari, Kamal, and Belu's father were
                    ...
                    a strain on the family.</p>

                {/* paragraph 3 */}
                <p className="fs-5 pb-2">Hari begins to think about better ways in which he could help his family and believes their
                ...
                {/* paragraph 4 */}
                <p className="fs-5 pb-2">Their situation changes a bit when the de Silva family comes into the village. They are a
                    ...
                    good husband without money and that it is now his responsibility to provide for his family.</p>

                {/* paragraph 5 */}
                <p className="fs-5 pb-2">The factory man begins to cause a stir when he tells Hari and other villagers about the
                    ...
                    decide to go to Bombay to speak with the government.</p>

                {/* paragraph 6 */}
                <p className="fs-5 pb-2">Hari is roused by the words of Adarkar and decides to go to Bombay to stand up for his
                    ...
                    to his friend Jagu.</p>

                {/* paragraph 7 */}
                <p className="fs-5 pb-2">Jagu agrees to let Hari work in his restaurant, so Hari sends home a postcard letting his
                    ...
                    wing and starts to teach him how to make watches and how to repair them.</p>

                {/* paragraph 8 */}
                <p className="fs-5 pb-2">During the time Hari is in Bombay, Lila finds succor from the de Silva family. When they
                    ...
                    quiet and kind and pays the girls well.</p>

                {/* paragraph 9 */}
                <p className="fs-5 pb-2">Monsoon season is hard for both Hari in Bombay and the villagers by the sea. When Hari hears
                    ...
                    watchmaking trade from Mr. Panwallah in the interim.</p>

                paragraph 10
                <p className="fs-5 pb-2">Hari returns and has an emotional reunion with his sisters. He is stunned to hear of his
                    ...
                    gruff way. Hari and his father can take Mother home for Diwali.</p>

                {/* paragraph 11 */}
                <p className="fs-5 pb-2">The celebrations are delightful and heartwarming for the family. Hari slips away for a
                    ...
                    doing, and Ali perks up, admiring Hari's will to adapt.</p>

                {/* paragraph 12 */}
                <p className="fs-5 pb-2">The story ends with the family contentedly celebrating, grateful for the positive changes in
                    their lives.</p>

                {/* Reference */}
                <div>
                    <h3 className="mt-4 fw-semibold">Reference</h3>
                    <p className="fs-5">GradeSaver. (2024a, March 10). The Village by the Sea Summary. <i>GradeSaver.</i>
