    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                ...
                {/* Paragraph 1 */}
                <p className="fs-5">The narrator is driving to London in his new BMW 1975 car when he picks up a hitchhiker. The
                ...
                {/* Paragraph 2 */}
                <p className="fs-5">They get to talking about the car, and the narrator proudly states it can hit 129 miles per
                ...
                {/* Paragraph 3 */}
                <p className="fs-5">The narrator is worried about the ticket, but the hitchhiker says it will be fine. The
                ...
                {/* Paragraph 4 */}
                <p className="fs-5">The narrator is concerned that the policeman will be checking up on the hitchhiker, but the
