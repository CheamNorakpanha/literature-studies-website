    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                <h1 className="mb-4 fw-bolder">The Hitch-Hiker</h1>
                <h2 className="mb-4 fw-bold">By Roald Dahl</h2>
                <h3 className="mb-4 fw-semibold text-center">Summary</h3>

                {/* Paragraph 1 */}
                <p className="fs-5 pb-2">The narrator is driving to London in his new BMW 1975 car when he picks up a hitchhiker. The
                    ...
                    is intrigued and says he's a writer, while the hitchhiker claims to be in a highly skilled trade.</p>

                {/* Paragraph 2 */}
                <p className="fs-5 pb-2">They get to talking about the car, and the narrator proudly states it can hit 129 miles per
                    ...
                    hod-carrier. Then he gives them a ticket and leaves, and they continue on their way. </p>

                {/* Paragraph 3 */}
                <p className="fs-5 pb-2">The narrator is worried about the ticket, but the hitchhiker says it will be fine. The
                    ...
                    announces that he has never been caught.</p>

                {/* Paragraph 4 */}
                <p className="fs-5 pb-2">The narrator is concerned that the policeman will be checking up on the hitchhiker, but the
                    ...
                    the books, and the narrator admires the hitchhiker's skills.</p>
