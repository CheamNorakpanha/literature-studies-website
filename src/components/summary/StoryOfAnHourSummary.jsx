    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                ...
                {/* paragraph 1 */}
                <p className="fs-5 pb-2">Louise Mallard has heart trouble, so she must be informed carefully about her husband's
                ...
                {/* paragraph 2 */}
                <p className="fs-5 pb-2">Louise sits down and looks out an open window. She sees trees, smells approaching rain, and
                ...
                {/* paragraph 3 */}
                <p className="fs-5 pb-2">Louise knows she'll cry again when she sees Brently's corpse. His hands were tender, and he
                ...
                {/* paragraph 4 */}
                <p className="fs-5 pb-2">Josephine comes to her door, begging Louise to come out, warning her that she'll get sick if
                ...
                {/* paragraph 5 */}
                <p className="fs-5 pb-2">The front door unexpectedly opens, and Brently comes in. He hadn't been in the train
