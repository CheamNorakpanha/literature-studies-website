    ...
    return (
        <div>
            <div class="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                ...
                {/* paragraph 1 */}
                <p class="fs-5 pb-2">Timber Woods, the narrator, arrives home at his bungalow to discover his partner, Harry
                ...
                {/* paragraph 2 */}
                <p class="fs-5 pb-2">Timber gets a knife from the kitchen in case Harry gets bitten, which he'll use to cut the
                ...
                {/* paragraph 3 */}
                <p class="fs-5 pb-2">Outside, the doctor tells Timber that the serum is by no means a guarantee of safety. They
                ...
                {/* paragraph 4 */}
                <p class="fs-5 pb-2">“It could be up the leg of his pajamas,” says Ganderbai. At that, Harry goes berserk and
                ...
                paragraph 5
                <p class="fs-5 pb-2">“Mr. Pope, you are of course quite sure you saw it in the first place?” asks Ganderbai.
                ...
                {/* paragraph 6 */}
                <p class="fs-5 pb-2">Timber stops the doctor outside and apologizes to Harry. He thanks the doctor for his help.
