    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify' }}>
                ...
                {/* paragraph 1 */}
                <p className="fs-5">In the streets of Verona, another brawl breaks out between the servants of the feuding noble
                ...
                {/* paragraph 2 */}
                <p className="fs-5">Romeo, the son of Montague, runs into his cousin Benvolio, who had earlier seen Romeo moping
                ...
                {/* paragraph 3 */}
                <p className="fs-5">Romeo and Benvolio, still discussing Rosaline, encounter the Capulet servant bearing the
                ...
                {/* paragraph 4 */}
                <p className="fs-5">The feast begins. A melancholy Romeo follows Benvolio and their witty friend Mercutio to
                ...
                {/* paragraph 5 */}
                <p className="fs-5">Romeo hurries to see his friend and confessor, Friar Lawrence, who, though shocked at the
                ...
                {/* paragraph 6 */}
                <p className="fs-5">The next day, Benvolio and Mercutio encounter Tybalt—Juliet's cousin—who, still enraged that
                ...
                {/* paragraph 7 */}
                <p className="fs-5">In her room, Juliet awaits the arrival of her new husband. The Nurse enters and, after some
                ...
                {/* paragraph 8 */}
                <p className="fs-5">Juliet returns home to discover the wedding has been moved ahead one day, and she is to be
                ...
                {/* paragraph 9 */}
                <p className="fs-5">Romeo learns only of Juliet's death and decides to kill himself rather than live without
                ...
                {/* paragraph 10 */}
                <p className="fs-5">The watch arrives, followed closely by the Prince, the Capulets, and Montague. Montague
