...
function DesireesBabySummary() {
  ...
  return (
    <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
      ...
      {/* Paragraph 1 */}
      <p className="fs-5 pb-2">The story opens with Madame Valmonde visiting Desiree and her baby. On her way to L'Abri,
      ...
      {/* Paragraph 2 */}
      <p className="fs-5 pb-2">Eighteen years later, Armand Aubigny suddenly falls in love with Desiree when he sees her
      ...
      {/* Paragraph 3 */}
      <p className="fs-5 pb-2">Madame Valmonde has a surprise awaiting her. She has not seen the baby for a month, and when
      ...
      {/* Paragraph 4 */}
      <p className="fs-5 pb-2">When the baby is three months old, the situation in the house changes. Desiree senses there
      ...
      {/* Paragraph 5 */}
      <p className="fs-5 pb-2">When Armand arrives back home, Desiree asks him about the baby. He responds that indeed the
      ...
      {/* Paragraph 6 */}
      <p className="fs-5 pb-2">Desperate, Desiree writes to her mother, Madame Valmonde, asking for help. Madame Valmonde
      ...
      {/* Paragraph 7 */}
      <p className="fs-5 pb-2">Several weeks later, Armand sets up a bonfire to get rid of Desiree's belongings. Among the
