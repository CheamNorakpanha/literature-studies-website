    ...
    return (
        <div>
            <div className="container bg-white p-4" style={{ textAlign: 'justify', marginTop: '5rem' }}>
                <h1 className="mb-4 fw-bolder">The Necklace</h1>
                <h2 className="mb-4 fw-bold">By Guy de Maupassant</h2>
                ...
                <p className="fs-5 pb-2">One Sunday, while she is out for a walk, Mathilde spots Madame Forestier. Feeling emotional,
                    ...
                    hands and tells Mathilde that the original necklace was just costume jewelry and not worth anything.</p>
